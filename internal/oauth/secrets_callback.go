...
// The callback must carry a state value matching expectedState, which the CLI generated
// and the platform bound into the authorization request. Validation fails closed.
