...
| ---- | ------- | ------ | ------- | ----- |
| Deploy | `cre workflow deploy hello-wf --yes` | ___ | ___ | ___ |
| Pause | `cre workflow pause hello-wf --yes` | ___ | ___ | ___ |
| Activate | `cre workflow activate hello-wf --yes` | ___ | ___ | ___ |
| Delete | `cre workflow delete hello-wf --yes` | ___ | ___ | ___ |
...
| # | Command | Status | Notes |
| - | ------- | ------ | ----- |
| 10.1 | `cre account link-key` | ___ | ___ |
| 10.2 | `cre account list-key` | ___ | Key visible: ___ |
| 10.3 | `cre account unlink-key` | ___ | Key removed: ___ |
...
| # | Command | Status | Notes |
| - | ------- | ------ | ----- |
| 11.2 | `cre secrets create test-secrets.yaml` | ___ | ___ |
| 11.3 | `cre secrets list` | ___ | Secrets visible: ___ |
| 11.4 | `cre secrets update test-secrets.yaml` | ___ | ___ |
| 11.5 | `cre secrets delete test-secrets.yaml` | ___ | ___ |
| 11.6a | `--timeout 72h` (valid) | ___ | ___ |
| 11.6b | `--timeout 999h` (invalid) | ___ | Expected: error |
