...
var workflowTemplates = []WorkflowTemplate{
	{Folder: "porExampleDev", Title: "Development PoR Example to understand capabilities and simulate workflows", ID: 1, Lang: TemplateLangGo},
	{Folder: "blankTemplate", Title: "New Workflow (blank)", ID: 2, Lang: TemplateLangGo},
	{Folder: "typescriptSimpleExample", Title: "Typescript Development Hello World example to demonstrate simple workflow", ID: 3, Lang: TemplateLangTS},
}
