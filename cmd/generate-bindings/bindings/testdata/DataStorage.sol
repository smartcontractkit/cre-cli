...
contract DataStorage {
    ...
    function getMultipleReserves() external view returns (UpdateReserves[] memory reserves) {
        reserves = new UpdateReserves[](2);
        reserves[0] = UpdateReserves(100, 200);
        reserves[1] = UpdateReserves(300, 400);
        return reserves;
    }
