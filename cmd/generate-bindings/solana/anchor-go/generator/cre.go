...
// func (c *DataStorage) WriteReportFrom<StructName>(runtime cre.Runtime, input <StructName>, remainingAccounts []*solana.AccountMeta, computeConfig *solana.ComputeConfig) cre.Promise[*solana.WriteReportReply] {
