...
func NewDataStorage(client *solana.Client) (*DataStorage, error) {
	type idlTypesStruct struct {
		anchorcodec.IdlTypeDefSlice `json:"types"`
	}
	...
	return &DataStorage{
		Codec:    &Codec{},
		IdlTypes: &idlTypes.IdlTypeDefSlice,
		client:   client,
	}, nil
}
...
type DataStorageCodec interface {
	...
	DecodeAccessLogged(log *solana1.Log) (*AccessLogged, error)
	DecodeDynamicEvent(log *solana1.Log) (*DynamicEvent, error)
	DecodeNoFields(log *solana1.Log) (*NoFields, error)
