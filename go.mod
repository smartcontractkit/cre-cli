...
require (
	...
	github.com/smartcontractkit/chainlink/v2 v2.29.1-cre-beta.0.0.20260420210431-d19bf891ad8f
...
require (
	...
	github.com/smartcontractkit/chainlink-deployments-framework v0.94.1 // indirect
